...
class MatrixService:
    ...
    def mapear_optimizacion_request(self, deposito: dict[str, float], puntos_entrega: list[PuntoEntrega]) ->list[list[float]]: 
    ...
    async def get_matriz_distancias(self, deposito: dict[str, float], puntos_entrega: list[PuntoEntrega]) -> list[list[float]]:
    ...
    async def get_matriz_tiempos(self, deposito: dict[str, float], puntos_entrega: list[PuntoEntrega]) -> list[list[float]]:
        coordenadas = self.mapear_optimizacion_request(deposito, puntos_entrega)
        coordenadas_OSRM = self.mapear_coordenadas_OSRM(coordenadas)
