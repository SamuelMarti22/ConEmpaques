...
class GeometryRouteService:
    ...
    async def get_geometry_route(self, ruta: RutaRepartidor, puntos_entrega: list[PuntoEntrega], deposito: dict[str, float]) -> list[list[float]]:
        ...
        coordenadas_entrega = ([coordenadas_deposito] +[[punto_entrega.longitud, punto_entrega.latitud] for punto_entrega in coordenadas_puntos_entrrega] +[coordenadas_deposito])
    ...
    def ordenar_puntos_entrega(self, puntos_entrega: list[PuntoEntrega], ruta: RutaRepartidor) -> list[PuntoEntrega]:
        diccionario_puntos_entrega = {punto_entrega.id: punto_entrega for punto_entrega in puntos_entrega}
