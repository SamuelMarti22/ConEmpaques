...
from app.models.schema import RutaRepartidor, OptimizacionResponse
...
PAYLOAD_VALIDO = {
    ...
    "capacidades_repartidores": [
        {"idRepartidor": 1, "capacidadRepartidor": 10}
    ]
}

# Datos mockeados
MATRIZ_DISTANCIAS_MOCK = [
    [0, 1000, 1500],
    [1000, 0, 800],
    [1500, 800, 0]
]
...
class TestOptimizarEndpoint:
    ...
    def test_optimizar_alias_repartidor(self, mock_optimizar):
        ...
        payload_con_alias = {
            ...
            "capacidades_repartidores": [
                {"idRepartidor": 99, "capacidadRepartidor": 100}
            ]
        }
